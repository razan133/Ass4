...
import Assignment4_prog3.Q2.Student;
 ...
 * @author hp
 */
public class TVC implements Initializable {
    ...
    private void addButtonHandle(ActionEvent event) throws SQLException {
        Integer SID = Integer.parseInt(textFiledStudentId.getText()); // student id
        Integer CID = Integer.parseInt(textFiledCourseId.getText()); // course id
